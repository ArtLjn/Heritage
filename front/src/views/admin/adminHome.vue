  ...
  <div class="common-layout">
    <el-container class="box">
      ...
      <el-aside :width="isCollapsed ? '64px' : '240px'" class="el-aside">
        <div class="logoBox" v-if="!isCollapsed"  @click="toggleCollapse">非遗平台</div>
...
export default {
  ...
  mounted() {
    ...
    this.asideMenu = []
    if (city === 'admin') {
      this.activeTabName = '/adminHome/index'
      this.editableTabs = [
        {
          title: "首页",
          index: "/adminHome/index",
        },
      ]
      this.asideMenu = [
        {
        ...
        {
          title: "管理",
          index: "/adminHome/manager",
          icon: "Management"
        }
      ]
    } else {
      this.activeTabName = '/adminHome/apply'
      this.editableTabs = [
        {
          title: "申请",
          index: "/adminHome/apply",
        },
      ]
      this.asideMenu = [
        {
